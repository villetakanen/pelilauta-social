...
- **Edge cases:** The spec defines implied states that alter observable behavior.
- **Compatibility:** Claims regarding v20 and the live Firebase contract cite inspectable evidence, and a departure from established behavior on live assets requires an approved decision.
...
- **Subtraction:** Execute subtraction last. Remove text derivable from authoritative artifacts using template sentence tests.

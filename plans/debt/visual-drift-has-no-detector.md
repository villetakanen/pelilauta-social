...
the book page, read by a human. That is the whole detector. A specimen that changes
between two merges is caught if someone looks at it, and otherwise is not caught.
...
design, and a suite that cries wolf is read by nobody. Where baselines are produced

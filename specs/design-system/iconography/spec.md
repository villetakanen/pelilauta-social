...
provenance:
  ...
  - "Human decision 2026-07-28: the open-source tier admits permissively licensed third-party artwork alongside project-created artwork. Each noun's PROVENANCE.md row states which kind it is and names the copyright holder and licence; the licence text is vendored beside the artwork. First admission: Fluent UI System Icons bin-recycle-24-filled (MIT, (c) 2020 Microsoft Corporation, microsoft/fluentui-system-icons@5ecd79ea56f2be0169859b3b881dcc890be932fc) adopted as the delete artwork, with the trash noun retired onto it."

...
- The compatibility layer gets no lexicon. It is migration scaffolding removed
  before `v21.0.0-rc.1`, and publishing its aliases beside the roles they alias
  is how a shim starts reading as vocabulary. A book says it exists and that it
  is going.
